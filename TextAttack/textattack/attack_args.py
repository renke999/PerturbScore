...
# NOTE 1225 增加了"random": "textattack.attack_recipes.RandomSwap1225",
ATTACK_RECIPE_NAMES = {
    ...
    "random1225": "textattack.attack_recipes.RandomSwap1225",
}
    ...
    def _create_attack_from_args(cls, args, model_wrapper):
        ...
        if args.attack_recipe:
            ...
            # NOTE true here
                ...
                if args.attack_recipe in ["random1225", "textfooler"]:
                    recipe = eval(
                        f"{ATTACK_RECIPE_NAMES[args.attack_recipe]}.build(model_wrapper, '{args.save_path}', '{args.training_dataset}')"
                    )
                else:
                    recipe = eval(
            ...
            if ARGS_SPLIT_TOKEN in args.search_method:
                ...
                search_method = eval(
                    f"{SEARCH_METHOD_CLASS_NAMES['greedy-word-wir']}()"
                )
            else:
