...
class ModelArgs:
    ...
    def _add_parser_args(cls, parser):
        ...
        # NOTE 20221226 add max_len, 注意model_group是mutually_exclusive_group，也就是只能存在一个选择的参数。
        parser.add_argument(
            "--my-max-length",
            type=int,
            default=512,
    ...
    def _create_model_from_args(cls, args):
        ...
        # NOTE true
            ...
            print()
            print("**********" * 5)
            print("args.my_max_length = {}".format(args.my_max_length))
            print("**********" * 5)
            print()
            model = textattack.models.wrappers.HuggingFaceModelWrapper(model, tokenizer, args.my_max_length)
